...
export class Version {
  ...
  constructor(major, minor, micro, special) {
    this.major = major;
    this.minor = minor;
    this.micro = micro;
...
export class GradientColor {
  ...
  constructor(type, direction, numStops, arrGradientStop) {
    this.type = type;
...
export class UIColor {
  ...
  constructor(type, antialiasLevel, color) {
    this.type = type;
...
class CSInterface {
  ...
  getHostEnvironment() {
     ...
     */
    if (this.hostEnvironment) return this.hostEnvironment;
  ...
  getExtensions(extensionIds) {
    ...
    let extensionsStr = window.__adobe_cep__.getExtensions(extensionIdsStr);
  ...
  getOSInformation() {
    ...
    if (navigator.platform == "Win32" || navigator.platform == "Windows") {
      let winVersion = "Windows platform";
